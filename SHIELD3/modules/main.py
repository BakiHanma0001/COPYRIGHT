...
gd_buttons = [              
        [
            ...
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/Satan_Fucker"),    
        ]
        ]
# ------------------------------------------------------------------------------- #
...
async def start(_, msg):
    REPO_BTN = [
        [
          InlineKeyboardButton("sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url="https://graph.org/file/04e458672f9f2e44c72c2.png"),
          ],
    ]
...
FORBIDDEN_KEYWORDS = ["porn", "xxx", "sex", "NCERT", "XII", "page", "Ans", "meiotic", "divisions", "System.in", "Scanner", "void", "nextInt", "𝕬𝖑𝖑𝖊𝖓", " 𝖈𝖑𝖆𝖘𝖘𝖗𝖔𝖔𝖒", "𝕰𝕮𝕿𝕴𝕺𝕹-𝕬"]
